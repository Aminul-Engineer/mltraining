...
https://raw.githubusercontent.com/Aminul-Engineer/mltraining/master/ML-workbook/train.csv

train <- read.csv('https://raw.githubusercontent.com/Aminul-Engineer/mltraining/master/ML-workbook/train.csv')
